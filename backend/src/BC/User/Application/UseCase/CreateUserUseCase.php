...
class CreateUserUseCase
{
    ...
    public function execute(UserDTO $dto): User
    {
        $user = new User(
            ...
            $dto->avatar !== null ? new UserAvatarValueObject($dto->avatar) : null,
            $dto->company !== null ? new UserCompanyValueObject($dto->company) : null,
            new UserRoleValueObject($dto->role),
            $dto->bio !== null ? new UserBioValueObject($dto->bio) : null,
