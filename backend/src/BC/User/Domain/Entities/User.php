...
class User implements JsonSerializable
{
    ...
    public function __construct(
        ...
        private ?UserAvatarValueObject $avatar,
        private ?UserCompanyValueObject $company,
        private UserRoleValueObject $role,
        private ?UserBioValueObject $bio,
    ...
    public function getId(): UserIdValueObject
    {
        return $this->id;
    }
    ...
    public function getFirstName(): UserFirstNameValueObject
    {
        return $this->firstName;
    }

    public function getFirstNameValue(): string
    {
        return $this->firstName?->value();
    }

    public function getLastName(): UserLastNameValueObject
    {
        return $this->lastName;
    }

    public function getLastNameValue(): string
    {
        return $this->lastName?->value();
    }

    public function getEmail(): UserEmailValueObject
    {
        return $this->email;
    }
    ...
    public function getPhone(): ?UserPhoneValueObject
    {
        return $this->phone;
    }
    ...
    public function getPasswordHash(): UserPasswordHashValueObject
    {
        return $this->passwordHash;
    }

    public function getPasswordHashValue(): string
    {
        return $this->passwordHash?->value();
    }

    public function getAvatar(): ?UserAvatarValueObject
    {
        return $this->avatar;
    }

    public function getAvatarValue(): ?string
    {
        return $this->avatar?->value();
    }

    public function getCompany(): ?UserCompanyValueObject
    {
        return $this->company;
    }

    public function getCompanyValue(): ?string
    {
        return $this->company?->value();
    }

    public function getRole(): UserRoleValueObject
    {
        return $this->role;
    }
    ...
    public function getBio(): ?UserBioValueObject
    {
        return $this->bio;
    }

    public function getBioValue(): ?string
    {
        return $this->bio?->value();
    }

    public function getRegistrationDate(): UserRegistrationDateValueObject
    {
        return $this->registrationDate;
    }

    public function getRegistrationDateValue(): string
    {
        return $this->registrationDate?->value();
    }

    public function getActive(): UserActiveValueObject
    {
        return $this->active;
    }
    ...
    public function jsonSerialize(): mixed
    {
        return [
            ...
            'avatar' => $this->getAvatarValue(),
            'company' => $this->getCompanyValue(),
            'role' => $this->getRoleValue(),
            'bio' => $this->getBioValue(),
