...
class Coworking implements JsonSerializable
{
    ...
    public function getId(): CoworkingIdValueObject { return $this->id; }
    public function getIdValue(): string { return $this->id->value(); }

    public function getName(): CoworkingNameValueObject { return $this->name; }
    public function getNameValue(): string { return $this->name?->value(); }

    public function getSlug(): CoworkingSlugValueObject { return $this->slug; }
    public function getSlugValue(): string { return $this->slug?->value(); }

    public function getAddress(): CoworkingAddressValueObject { return $this->address; }
    public function getAddressValue(): string { return $this->address?->value();  }

    public function getCity(): CoworkingCityValueObject { return $this->city; }
    public function getCityValue(): string { return $this->city?->value(); }

    public function getPostalCode(): CoworkingPostalCodeValueObject { return $this->postalCode; }
    public function getPostalCodeValue(): string { return $this->postalCode?->value(); }

    public function getPhone(): ?CoworkingPhoneValueObject { return $this->phone; }
    public function getPhoneValue(): ?string { return $this->phone?->value(); }

    public function getEmail(): ?CoworkingEmailValueObject { return $this->email; }
    public function getEmailValue(): ?string { return $this->email?->value(); }

    public function getSchedule(): ?CoworkingScheduleValueObject { return $this->schedule; }
    public function getScheduleValue(): ?string { return $this->schedule?->value(); }

    public function getDescription(): ?CoworkingDescriptionValueObject {return $this->description;}
    public function getDescriptionValue(): ?string { return $this->description?->value(); }

    public function getLatitude(): ?CoworkingLatitudeValueObject { return $this->latitude; }
    public function getLatitudeValue(): ?float { return $this->latitude?->value(); }

    public function getLongitude(): ?CoworkingLongitudeValueObject { return $this->longitude;}
    public function getLongitudeValue(): ?float { return $this->longitude?->value(); }

    public function getCover(): ?CoworkingCoverValueObject { return $this->cover; }
    public function getCoverValue(): ?string { return $this->cover?->value(); }

    public function getGallery(): ?CoworkingGalleryValueObject { return $this->gallery; }
    public function getGalleryValue(): ?array { return $this->gallery?->value();}
