...
class Space implements JsonSerializable
{
    ...
    public function getId(): SpaceIdValueObject { return $this->id; }
    public function getIdValue(): string { return $this->id->value(); }

    public function getCoworkingId(): SpaceCoworkingIdValueObject { return $this->coworkingId; }
    public function getCoworkingIdValue(): string { return $this->coworkingId?->value(); }

    public function getName(): SpaceNameValueObject { return $this->name; }
    public function getNameValue(): string { return $this->name?->value(); }

    public function getSlug(): SpaceSlugValueObject { return $this->slug; }
    public function getSlugValue(): string { return $this->slug?->value(); }

    public function getType(): SpaceTypeValueObject { return $this->type; }
    public function getTypeValue(): string { return $this->type?->value(); }

    public function getDescription(): ?SpaceDescriptionValueObject { return $this->description; }
    public function getDescriptionValue(): ?string { return $this->description?->value(); }

    public function getCapacity(): SpaceCapacityValueObject { return $this->capacity; }
    public function getCapacityValue(): int { return $this->capacity?->value(); }

    public function getPriceHour(): ?SpacePriceHourValueObject { return $this->priceHour; }
    public function getPriceHourValue(): ?float { return $this->priceHour?->value(); }

    public function getPriceDay(): ?SpacePriceDayValueObject { return $this->priceDay; }
    public function getPriceDayValue(): ?float { return $this->priceDay?->value(); }

    public function getPriceMonth(): ?SpacePriceMonthValueObject { return $this->priceMonth; }
    public function getPriceMonthValue(): ?float { return $this->priceMonth?->value();  }

    public function getSizeM2(): ?SpaceSizeM2ValueObject { return $this->sizeM2; }
    public function getSizeM2Value(): ?float { return $this->sizeM2?->value(); }

    public function getAvailable(): SpaceAvailableValueObject { return $this->available; }
    public function getAvailableValue(): bool { return $this->available?->value(); }
